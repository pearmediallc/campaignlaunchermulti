...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://graph.facebook.com", "https://www.facebook.com", "https://creative-library.onrender.com", "https://*.cloudfront.net", "https://facebookswipefile-443507027642.us-central1.run.app"],
      fontSrc: ["'self'", "data:"],
      objectSrc: ["'none'"],
      mediaSrc: ["'self'", "blob:"],
